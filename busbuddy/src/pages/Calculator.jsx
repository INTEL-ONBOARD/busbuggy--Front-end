  ...
  function Calculator() {
    ...
    const [originMilestone, setOriginMilestone] = useState(null); // Milestone for origin
    const [destinationMilestone, setDestinationMilestone] = useState(null); // Milestone for destination
    ...
    const handleSuggestionClick = (suggestion, setField, setMilestone) => {
      ...
      setMilestone(suggestion.milestone); // Store the milestone for selected suggestion
    ...
    const toggleFareLoad = () => {
      ...
      // Calculate and log the difference between milestones
