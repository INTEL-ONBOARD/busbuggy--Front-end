            ...
            <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md"> 
              <div class="bg-tranparent w-full rounded-lg divide-y divide-gray-200">
                ...
                <input 
                    ...
                    style={{ backgroundColor: 'rgba(255, 255, 255, 0.6)' }} 
                />
                  <button type="submit" class="transition duration-200 bg-orange-500 hover:bg-orange-600 focus:bg-orange-700 focus:shadow-sm focus:ring-4 focus:ring-orange -500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
